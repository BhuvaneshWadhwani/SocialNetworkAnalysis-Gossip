...
#visualization ng key player analysis
...
#visualization pg key player analysis
```{r, fig.height = 10, fig.width = 10}
# color nodes with highest scores 
...
#centrality measures for negative network
```{r}
...
```
#centrality measures for positive network
```{r}
